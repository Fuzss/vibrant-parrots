...
public class ParrotSpawningHandler {
    ...
    /**
     * @see net.minecraft.world.level.ServerLevelAccessor#getCurrentDifficultyAt(BlockPos)
     * @deprecated this should use the actual vanilla method once a way is found to bypass the chunk-loading lock issue
     */
    @Deprecated
